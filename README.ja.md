...
他の shape に完全に含まれる shape が穴になります。穴の内側に入れ子になった shape は、再び中身の詰まった島として扱われます。穴は napari の連結リング形式のまま単一ポリゴンとして COCO に書き出され、`pycocotools` で正しくラスタライズされます。`area` も穴を除いた値になります。
